...
/**
 * Implementation of {@link StockEventPublisher} using Spring {@code ApplicationEventPublisher}
...
public class StockEventPublisherImpl implements StockEventPublisher {
    ...
    private static final Logger log = LoggerFactory.getLogger(StockEventPublisherImpl.class);

    private final ApplicationEventPublisher applicationEventPublisher;

    public StockEventPublisherImpl(ApplicationEventPublisher applicationEventPublisher) {
        this.applicationEventPublisher = applicationEventPublisher;
    }

    @Override
    public void publishStockLowWarning(StockLowWarningEvent event) {
        publishAfterCommit(event, "stock.low.warning");
    }

    @Override
    public void publishStockExpireWarning(StockExpireWarningEvent event) {
        publishAfterCommit(event, "stock.expire.warning");
    }

    @Override
    public void publishBomVersionChanged(BomVersionChangedEvent event) {
        publishAfterCommit(event, "bom.version.changed");
    }
